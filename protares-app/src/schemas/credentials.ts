...
export const nmcVerificationSchema = z.object({
  nmcPin: z
    ...
    .regex(
      /^[0-9]{2}[A-Z][0-9]{4}[A-Z]$/,
      'Please enter a valid NMC PIN (e.g., 12A3456B)'
    ),
...
export const firstAidCertificateSchema = z.object({
  certificateType: z.enum(
    ['st_john_ambulance', 'british_red_cross', 'hse_first_aid_at_work', 'other'],
    {
...
export type FirstAidCertificateFormData = z.infer<
  typeof firstAidCertificateSchema
>;
